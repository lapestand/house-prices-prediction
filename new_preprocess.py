...
if False:
    ...
    houses["tapu_durumu"].fillna("kat mulkiyeti", inplace=True)
...
aidat_mean = int(houses[houses["aidat"] < 10000]["aidat"].mean())
...
houses["fiyat"] = houses["fiyat"].astype(int)
...
houses["kira_getirisi"] = houses["kira_getirisi"].astype(int)
...
houses["depozito"] = houses["depozito"].astype(int)

print("depozito  -- DONE")


houses["isinma_tipi"].fillna("belirtilmemis", inplace=True)
...
houses["takas"] = houses["takas"].astype(bool)
...
houses.to_csv("house_prices.csv")
